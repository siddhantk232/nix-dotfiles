...
mapper("n", "<leader>pw", ":lua require('telescope.builtin').grep_string { search = vim.fn.expand(\"<cword>\") }<CR>")

mapper("n", "<leader>pb", ":lua require('telescope.builtin').buffers()<CR>")

mapper("n", "<leader>vrc", ":lua require('siddhant.telescope').search_dotfiles()<CR>")

mapper("n", "<leader>ww", ":lua require('siddhant.telescope').search_vimwiki()<CR>")

mapper("n", "<leader>gc", ":lua require('siddhant.telescope').git_branches()<CR>")
